...
//    ResponseEntity<?> logout(@RequestBody MultiValueMap<String, Object> body);
//
//    @PostMapping(value = "${application.security.keycloak.newAccessTokenUrl}",
//            consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE)
//    ResponseEntity<KeycloakAccessTokenResponse> refreshToken(@RequestBody MultiValueMap<String, Object> body);
//
//    @PostMapping(value = "${application.security.keycloak.newAccessTokenUrl}",
//            consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE)
//    ResponseEntity<KeycloakAccessTokenResponse> getKeycloakUserToken(@RequestBody MultiValueMap<String, Object> body);
//
//    @PostMapping(value = "${application.security.keycloak.newAccessTokenUrl}",
//            consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE)
