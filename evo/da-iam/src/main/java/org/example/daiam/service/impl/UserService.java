...
//    }
//
//    public List<User> filter(FilterUsersRequest request) {
//        return userRepoImpl.filterByField(request);
//    }
//
//    public User findById(String id) {
//        return userRepo.findById(UUID.fromString(id)).orElseThrow(() -> new NotFoundException("User not found"));
//    }
//
